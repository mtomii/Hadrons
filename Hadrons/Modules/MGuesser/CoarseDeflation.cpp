/*
 * CoarseDeflation.cpp, part of Hadrons (https://github.com/aportelli/Hadrons)
 *
...
template class HADRONS_NAMESPACE::MGuesser::TCoarseDeflation<CoarseFermionEigenPack<FIMPL,200>>;
...
template class HADRONS_NAMESPACE::MGuesser::TCoarseDeflation<CoarseFermionEigenPack<FIMPL,1000>>;

template class HADRONS_NAMESPACE::MGuesser::TCoarseDeflation<CoarseFermionEigenPack<FIMPLF,HADRONS_DEFAULT_LANCZOS_NBASIS>>;
template class HADRONS_NAMESPACE::MGuesser::TCoarseDeflation<CoarseFermionEigenPack<FIMPLF,200>>;
...
template class HADRONS_NAMESPACE::MGuesser::TCoarseDeflation<CoarseFermionEigenPack<FIMPLF,1000>>;
